// <copyright file="Entitlements.cs" company="Quamotion bv">
...
namespace Kaponata.iOS.DeveloperProfiles
{
    ...
    public class Entitlements
    {
        ...
        /// <summary>
        /// Gets a value indicating whether other processes (like the debugger) can attach to the app.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public bool? GetTaskAllow { get; private set; }

        /// <summary>
        /// Gets the value of the push notification entitlement.
        /// </summary>
        /// <remarks>
        /// Push notifications let your app alert the user even when your iOS or OS X app is not executing.
        /// </remarks>
        public string ApsEnvironment { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the App Store code signed builds are allowed
        /// to be tested using iTunes Connect.
        /// </summary>
        /// <seealso href="https://developer.apple.com/library/ios/qa/qa1830/_index.html"/>
        public bool? BetaReportsActive { get; private set; }

        /// <summary>
        /// Gets the list of keychain access groups. A keychain access group is a group of applications,
        /// identified by an ID, that can share data.
        /// </summary>
        public IList<string> KeychainAccessGroups { get; private set; }
        ...
        /// <summary>
        /// Gets a list of domains with which the app is assocated, to access specific services—such
        /// as Safari saved passwords and activity continuation, or universal links.
        /// </summary>
        public IList<string> AssociatedDomains { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the Enables App Sandbox is enabled for a target in an Xcode project.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether the application is allowed access to group containers that are shared among multiple apps produced by a single development team, and allows certain additional interprocess communication between the apps.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public IList<string> ApplicationGroups { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read-only access to the user’s Movies folder and iTunes movies.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? MoviesReadOnly { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read/write access to the user’s Movies folder and iTunes movies.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? MoviesReadWrite { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read-only access to the user’s Music folder.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? MusicReadOnly { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read/write access to the user’s Music folder.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? MusicReadWrite { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read-only access to the user’s Pictures folder.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? PicturesReadOnly { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read/write access to the user’s Pictures folder.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? PicturesReadWrite { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is allowed to communicate with AVB devices.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? AudioVideoBridging { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is allowed to interact with Bluetooth devices.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        ...
        /// <summary>
        /// Gets a value indicating whether the application is allowed to capture of movies and still images using the built-in camera, if available.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        ...
        /// <summary>
        /// Gets a value indicating whether the application is allowed to interact with FireWire devices (currently, does not support interaction with audio/video devices such as DV cameras).
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? Firewire { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is allowed to record audio using the built-in microphone, if available, along with access to audio input using any Core Audio API that supports audio input.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        ...
        /// <summary>
        /// Gets a value indicating whether the application is allowed to interact with serial devices.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        ...
        /// <summary>
        /// Gets a value indicating whether the application is allowed to interact with USB devices, including HID devices such as joysticks.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        ...
        /// <summary>
        /// Gets a value indicating whether the application is granted read/write access to the user’s Downloads folder.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? DownloadsReadWrite { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted to make use of app-scoped bookmarks and URLs.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? BookmarksAppScope { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is allows to make use of document-scoped bookmarks and URLs.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? BookmarksDocumentScope { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read-only access to files the user has selected using an Open or Save dialog.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? UserSelectedFilesReadOnly { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read/write access to files the user has selected using an Open or Save dialog.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? UserSelectedFilesReadWrite { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is allowed to write executable files.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? UserSelectedFilesExecutable { get; private set; }

        /// <summary>
        /// Gets a value indicating whether a child process inherits the parent’s sandbox.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? InheritSecurity { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted access to
        ...
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? NetworkClient { get; private set; }
        ...
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? NetworkServer { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read/write access to contacts in the user’s address book; allows apps to infer the default address book if more than one is present on a system.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? AddressBook { get; private set; }

        /// <summary>
        /// Gets a value indicating whether the application is granted read/write access to the user’s calendars.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? Calendars { get; private set; }

        /// <summary>
        /// Gets a value which indicates whether the application is allowd to make
        ...
        /// <summary>
        /// Gets a value which indicates whether the application is able to print.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        ...
        /// <summary>
        /// Gets a value which indicates whether the application is able to use specific AppleScript scripting access groups within a specific scriptable app.
        /// </summary>
        /// <remarks>
        /// This entitlement is specific to the OS X implementation of App Sandbox.
        /// It is not available in iOS.
        /// </remarks>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW19"/>
        public bool? ScriptingTargets { get; private set; }

        /// <summary>
        /// Gets the merchant IDs to use for in-app payments.
        /// </summary>
        ...
        public IList<string> InAppPayments { get; private set; }

        /// <summary>
        /// Gets the list of network extensions which are enabled.
        /// </summary>
        public IList<string> NetworkExtensions { get; private set; }

        /// <summary>
        /// Gets a value indicating whether inter-app audio is enabled for this app. Inter-app audio allows your app to export audio that other apps can use.
        /// </summary>
        public bool? InterAppAudio { get; private set; }

        /// <summary>
        /// Gets a value indicating whether Health Kit is enabled for this app.
        /// </summary>
        public bool? HealthKit { get; private set; }

        /// <summary>
        /// Gets the identifier of the app, as used to support iCloud storage of key-value information for your app.
        /// </summary>
        ...
        public string iCloudKeyValueStore { get; private set; }

        /// <summary>
        /// Gets the bundle identifiers of the apps whose iCloud Document Store this app can access.
        /// </summary>
        /// <seealso href="https://developer.apple.com/library/content/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingiCloud.html"/>
        [SuppressMessage("StyleCop.CSharp.NamingRules", "SA1300:Element should begin with upper-case letter", Justification = "Standard iOS naming.")]
        public IList<string> iCloudDocumentStore { get; private set; }

        /// <summary>
        /// Gets a value indicating whether HomeKit is enabled for this app.
        /// </summary>
        public bool? HomeKit { get; private set; }

        /// <summary>
        /// Gets the default data protection rule applied to this app.
        /// </summary>
        public string DefaultDataProtection { get; private set; }

        /// <summary>
        /// Gets the VPN settings applied to this app.
        /// </summary>
        public IList<string> VpnApi { get; private set; }

        /// <summary>
        /// Gets a value indicating whether SiriKit is enabled for this app.
        /// </summary>
        public bool? SiriKit { get; private set; }

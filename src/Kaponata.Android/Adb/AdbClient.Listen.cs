...
namespace Kaponata.Android.Adb
{
    ...
    public partial class AdbClient
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                throw new ArgumentNullException(nameof(onNewDeviceList));
            }
            ...
            {
                this.logger.LogWarning(exception, "The server unexpectedly close the connection when tracking for devices.");
                return false;
            }
        }
        ...
        /// </returns>
        public virtual async Task<string> ReadDeviceEventAsync(AdbProtocol protocol, CancellationToken cancellationToken)
        {
